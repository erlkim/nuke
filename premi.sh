...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To Erlkim Tunnel ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Author : ${green} Erlkim Tunnel® ${NC}${YELLOW}(${NC} ${green} Erlkim Tunnel ${NC}${YELLOW})${NC}"
echo -e " © Recode By My Self Erlkim Store ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/erlkim/key/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/erlkim/key/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/erlkim/nuke/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/erlkim/key/main/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/erlkim/key/main/ip | grep $MYIP | awk '{print $3}')
...
<code>────────────────────</code>
<i>Automatic Notification from Github ErlkimVPN</i>
"'&reply_markup={"inline_keyboard":[[{"text":"CHANNEL","url":"https://t.me/+Nfe3WuSsl2hhMzNl"},{"text":"ORDER","url":"https://t.me/erlkim"}]]}'
...
port 587
auth on
user bakoltahu@gmail.com
from bakoltahu@gmail.com
password 31102021 
logfile ~/.msmtp.log
EOF
